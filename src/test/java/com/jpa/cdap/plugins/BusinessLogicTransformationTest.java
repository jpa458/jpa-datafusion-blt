 ...
 */
public class BusinessLogicTransformationTest {
  private static final Schema INPUT = Schema.recordOf("input",
                                                      Schema.Field.of("a", Schema.of(Schema.Type.STRING)),
                                                      Schema.Field.of("b", Schema.of(Schema.Type.STRING)),
                                                      Schema.Field.of("c", Schema.of(Schema.Type.STRING)),
                                                      Schema.Field.of("d", Schema.of(Schema.Type.STRING)),
                                                      Schema.Field.of("status_display_original", Schema.of(Schema.Type.STRING)));
  @Test
  public void testMyTransform() throws Exception {
    BusinessLogicTransformation.Config config = new BusinessLogicTransformation.Config("",INPUT.toString());
    Transform<StructuredRecord, StructuredRecord> transform = new BusinessLogicTransformation(config);
    ...
    transform.transform(StructuredRecord.builder(INPUT)
                          ...
                          .set("c", "3")
                          .set("d", "4")
                          .set("status_display_original", "5").build(), emitter);
